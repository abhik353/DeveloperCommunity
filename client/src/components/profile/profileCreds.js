        ...
        const expItems = experience.map(exp => (
            <li key={exp._id} className="list-group-item">
                ...
                <p>
                    ...
                    {exp.till === null ? ('Current'):(<Moment format="DD/MM/YYYY">{exp.till}</Moment>)}
                </p>
        ...
        const eduItems = education.map(edu => (
            <li key={edu._id} className="list-group-item">
                ...
                <p>
                    ...
                    {edu.till === null ? ('Current'):(<Moment format="DD/MM/YYYY">{edu.till}</Moment>)}
                </p>
            ...
            <div className="row">
                <div className="col-md-6">
                    ...
                    {expItems.length > 0 ? (
                        ...
                        <p className="text-center">No expereience found</p>
                    )}
                </div>
                <div className="col-md-6">
                    <h3 className="text-center text-info">
